    ...
    <div class="div_tabla_editar_empleados">
        <div class="contenidos_columnas">
            ...
            <div  class="secundarioderecha form-group">
                 <?= "<a href='http://".SERVER_NAME_BA."/site/autologin?id=$model->id' ><img  src='/themes/metronic/admin/pages/img/tituloBila.png' class='zoom' style='width: 31%; margin-left: -9%'/></a>" ?>
        ...
        <div class="contenidos_columnas">
            ...
            <div class="secundarioderecha form-group">
                <?= "<a href='http://".SERVER_NAME_TR."/site/autologin?id=$model->id' ><img  src='/themes/metronic/admin/pages/img/tenting_route.png' class='zoom' style='width: 33%; margin-left: -9%'/></a>" ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6"><a href="javascript:;" class="btn btn-block" target="_blank">ICONO</a></div>
        </div>
      </div>
