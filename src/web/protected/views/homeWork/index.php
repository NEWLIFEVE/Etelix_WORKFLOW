<div id="dashBoard" style="margin-top: 30px;">
    <div class="div_tabla_editar_empleados">
        ...
        <div class="contenidos_columnas">
            <div class="secundario form-group">
                   <?="<a href='http://aru.ribela.net/site/autoLogin?id=$model->id'><img src='/themes/metronic/admin/pages/img/icono_ribela-05.png' class='zoom' alt='' style='width: 25%; margin-left: 30% ' /></a>"?>                         
                   <?php //"<a href='http://aru.local/site/autoLogin?id=$model->id'><img src='/themes/metronic/admin/pages/img/icono_ribela-05.png' class='zoom' alt='' style='width: 25%; margin-left: 30% ' /></a>"?>                         
            </div>
            <div class="secundario form-group">
                  <?="<a href='http://pig.ribela.net/site/autoLogin?id=$model->id'><img id ='load_photo' src='/themes/metronic/admin/pages/img/icono_ribela-07.png' class='zoom' alt='' style='width: 25%; margin-left: 13%' /></a>"?>
                  <?php //"<a href='http://pig.local/site/autoLogin?id=$model->id'><img id ='load_photo' src='/themes/metronic/admin/pages/img/icono_ribela-07.png' class='zoom' alt='' style='width: 25%; margin-left: 13%' /></a>"?>
            </div>
            <div class="secundarioderecha form-group">
